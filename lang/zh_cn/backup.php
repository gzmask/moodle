...
/**
 * Strings for component 'backup', language 'zh_cn', branch 'MOODLE_20_STABLE'
 *
 * @package   backup
...
$string['errorinvalidformat'] = '无效的备份格式。';
$string['errorinvalidformatdesc'] = '上传的文件不是有效的Moodle备份文件，不能恢复。';
$string['errorminbackup20version'] = '此备份文件由开发版的Moodle备份创建 ({$a->backup})。最低需求是{$a->min}。不能恢复。';
$string['errormoodle1format'] = '正在恢复Moodle 1.9的备份';
$string['errormoodle1formatdesc'] = '此备份文件由Moodle 1.x创建，现在不能恢复到Moodle 2。此功能将在未来的更新中提供。';
$string['errormoodle1format_help'] = 'Moodle 2现在不支持恢复Moodle 1.x的备份。一个临时的解决方案是在Moodle 1.9网站上恢复您的Moodle 1.x备份，然后升级到Moodle 2。当升级结束后，您就能建立可以在其它Moodle 2.0网站恢复的新备份。';
