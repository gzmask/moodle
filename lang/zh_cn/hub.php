...
/**
 * Strings for component 'hub', language 'zh_cn', branch 'MOODLE_20_STABLE'
 *
 * @package   hub
...
$string['moodleorgregistrationdetail'] = 'MOOCH是主社群中心服务器，地址是hub.moodle.org。在MOOCH注册您的网站可以帮助我们统计Moodle在全世界的使用情况。您也可以加入一个邮件列表，它的邮件很少，只是提前提供一些关于安全修正和Moodle新版本发行的通知。';
$string['moodleorgregistrationdetail2'] = '通过此选项可以将您的Moodle网站在MOOCH（hub.moodle.org）注册。注册是免费的。这要做的主要好处是您会被加入一个邮件列表，这个列表信息不多，只有重要的通知，例如安全警告和Moodle新版本的发行通知。缺省情况下，您的信息不会被公开，也永远不会被出卖或转让给任何其它人。收集这些信息的唯一目的是支持与服务，同时帮助我们建立一个Moodle社区整体统计图。
您可以选择将您的网站的名称、国家和URL加入公开的Moodle网站列表中。
所有新注册都会被人工审核，然后才加入列表，但只要已经加入过，您就可以随时更新您的注册（和您在公开列表中的信息）。';
...
$string['publishonmoodleorg'] = '发布到MOOCH';
...
$string['registeredon'] = '已在此注册';
$string['registeredsites'] = '已注册网站';
$string['registeron'] = '注册您的网站';
$string['registeronmoodleorg'] = '在moodle.org（MOOCH）注册';
$string['registeronspecifichub'] = '在指定的中心服务器注册';
...
$string['shareonmoodleorg'] = '上传此课程到MOOCH';
