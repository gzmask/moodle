...
/**
 * Strings for component 'editor_tinymce', language 'zh_cn', branch 'MOODLE_20_STABLE'
 *
...
$string['common:browseimage'] = '查找或上传一个图片...';
$string['common:browsemedia'] = '查找或上传一个音频、视频或applet...';
...
$string['dragmath:dragmath_javaneeded'] = '若要使用此网页，你需要一个支持Java的浏览器。从{$a}下载最新的Java插件。
';
$string['dragmath:dragmath_title'] = 'DragMath公式编辑器
';
...
$string['media_dlg:flv_buffer'] = '缓衝区';
$string['media_dlg:flv_defaultvolume'] = '预设音量';
$string['media_dlg:flv_hiddengui'] = '隐藏 GUI';
$string['media_dlg:flv_jscallback'] = 'Script 唿叫';
$string['media_dlg:flv_loop'] = '循环';
$string['media_dlg:flv_options'] = 'Flash影片选项';
$string['media_dlg:flv_scalemode'] = '缩放模式';
$string['media_dlg:flv_showscalemodes'] = '显示缩放模式';
$string['media_dlg:flv_smoothvideo'] = '平滑播放';
...
$string['paste:plaintext_mode_sticky'] = '粘贴现在工作在纯文本模式。再次点击切换回正常粘贴模式。粘贴过一次之后，也会回到正常粘贴模式。';
