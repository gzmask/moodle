...
/**
 * Strings for component 'lesson', language 'zh_cn', branch 'MOODLE_20_STABLE'
 *
 * @package   lesson
...
$string['importppt_help'] = '将PowerPoint 2003制作的幻灯片另存为web页面，并用zip打包后，用此功能可以将这些页面导入到教程中。';
...
$string['pptsuccessfullimport'] = '从上传的PowerPoint幻灯片导入页面成功';
