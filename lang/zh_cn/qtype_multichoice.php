...
/**
 * Strings for component 'qtype_multichoice', language 'zh_cn', branch 'MOODLE_20_STABLE'
 *
...
$string['addingmultichoice'] = '添加一道选择题';
...
$string['multichoice_help'] = '从多个选项中做选择来回答问题，题目中可以包含图片。有两种选择题——单项选择和多项选择。';
$string['multichoicesummary'] = '从预先定义的选项中选择一个或多个做为答案。';
...
$string['shuffleanswers_help'] = '如果启用，且测验设置中的”随机排列题目选项“也被启用，那么每次答题时选项的顺序都会是随机的。';
