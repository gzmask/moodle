...
/**
 * Strings for component 'xmldb', language 'zh_cn', branch 'MOODLE_20_STABLE'
 *
 * @package   xmldb
...
$string['duplicatekeyname'] = '有同名键值已经存在';
$string['edit'] = '编辑';
...
$string['masterprimaryuniqueordernomatch'] = '您的外键中的所有字段的定义顺序，都必须与它们在对应的表中的 UNIQUE KEY 中的定义顺序相同。';
$string['missing'] = '缺失';
...
$string['nomasterprimaryuniquefound'] = '您的外键对应的字段必须是对应表中的主键或唯一键。注意，字段只是 UNIQUE INDEX 是不够的。';
$string['nomissingindexesfound'] = '没有发现缺失的索引，您的数据库不需要做任何操作。';
...
$string['violations'] = '违例';
$string['wrong'] = '错误';
$string['wrongdefaults'] = '错误的默认值';
$string['wrongints'] = '错误的整型数';
$string['wronglengthforenum'] = '枚举字段的长度不正确';
$string['wrongreservedwords'] = '当前使用的保留字<br />（表名如果使用{$CFG->prefix}，就不用留意这个问题）';
