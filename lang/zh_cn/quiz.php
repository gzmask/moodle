...
/**
 * Strings for component 'quiz', language 'zh_cn', branch 'MOODLE_20_STABLE'
 *
 * @package   quiz
...
$string['addingcalculated'] = '添加一道计算题';
$string['addingdescription'] = '添加一个描述';
$string['addingessay'] = '添加简答题';
...
$string['attemptsallowedn'] = '允许答题次数：{$a}';
...
$string['confirmclose'] = '您将要结束这次试答。一旦结束，您将不能再修改您的答案。';
...
$string['decimalplaces_help'] = '此设置决定在显示分数和评分时小数点后有几位数字。它只影响成绩的显示，并不影响成绩在数据库的保存和内部计算。后两者会使用完整的精度。';
...
$string['editingessay'] = '编辑简答题';
$string['editingmatch'] = '编辑匹配题';
$string['editingmultianswer'] = '编辑完形题';
$string['editingmultichoice'] = '编辑一道选择题';
$string['editingnumerical'] = '编辑一道数字题';
...
$string['filloutnumericalanswer'] = '您至少提供一种可能的答案和容许误差。第一个匹配的答案将被用来确定分数和反馈。如果您在最后提供无答案的反馈，它们将会显示给与任何答案都不匹配的学生。';
$string['filloutoneanswer'] = '您至少必须填写一个可能的答案。空白的答案将不被使用。“*”可被用做通配符，与任意字符串匹配。第一个匹配的答案将被用来确定分数和反馈。';
...
$string['paragraphquestion'] = '不支持第 {$a} 行的段落题目。此题目会被忽略。';
$string['parent'] = '父类别';
...
$string['quiz:emailconfirmsubmission'] = '提交时获得email确认';
$string['quiz:emailnotifysubmission'] = '获得提交的Email通知';
...
$string['requirepasswordmessage'] = '知道密码才能参加此测验';
$string['requiresafeexambrowser'] = '必须使用 Safe Exam Browser';
...
$string['rqp'] = '远程试题';
$string['rqps'] = '远程试题';
$string['safebrowsererror'] = '此测验被设置为只能使用 Safe Exam Browser 答题。您不能使用现在的浏览器答题。';
$string['safebrowsernotice'] = '此测验被设置为只允许学生使用 Safe Exam Browser 答题。';
...
$string['subnetwrong'] = '此测验只能从特定位置访问，而此计算机不在允许之列。';
...
$string['youcannotwait'] = '在您可以再次答题之前，此测验就已经关闭了。';
$string['youmustwait'] = '在再次答题之前您必须等待。{$a}之后您才可以再次答题。';
