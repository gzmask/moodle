...
/**
 * Strings for component 'forum', language 'zh_cn', branch 'MOODLE_20_STABLE'
 *
 * @package   forum
...
$string['nownotsubscribed'] = '{$a->name} 将不再通过email收到“{$a->forum}”的帖子。';
$string['nownottracking'] = '{$a->name} 不再跟踪“{$a->forum}”了。';
$string['nowsubscribed'] = '{$a->name} 将通过email收到“{$a->forum}”的帖子。';
...
$string['subscribeenrolledonly'] = '抱歉，只有已选课用户才能订阅讨论区，通过email接收讨论区帖子。';
...
$string['unsubscribealldone'] = '已取消您所有的订阅，但仍能收到强制订阅的通知。如果您不想收到本站发出的任何email，请到您的个人资料页面禁用email地址。';
$string['unsubscribeallempty'] = '抱歉，您没有订阅任何讨论区。如果您不想收到本站的任何email，请在个人资料中禁用email地址。';
