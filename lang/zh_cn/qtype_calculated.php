...
/**
 * Strings for component 'qtype_calculated', language 'zh_cn', branch 'MOODLE_20_STABLE'
 *
...
$string['addingcalculated'] = '增加一道计算题';
...
$string['calculated_help'] = '在计算题中，每道题都可以使用通配符（放在大括号中），而在答题时通配符会被替换。例如，题目是“长为{l}宽为{w}的长方形面积是多少？”的正确答案计算公式是“{l}*{w}”（ * 表示乘法）。';
$string['calculatedsummary'] = '计算题和数字题类似，但在答题时，题目中的数可以从一个集合中随机选择。';
