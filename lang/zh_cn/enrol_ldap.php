...
/**
 * Strings for component 'enrol_ldap', language 'zh_cn', branch 'MOODLE_20_STABLE'
 *
 * @package   enrol_ldap
...
$string['role_mapping'] = '<p>对您想从LDAP分配的每个角色，您需要指定这些角色的课程组位于哪些场景。用“;”分隔不同的场景。</p><p>您还需要指定您的LDAP服务器使用哪个属性保存组成员。通常是“member”或“memberUid”</p>';
