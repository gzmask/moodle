...
/**
 * Strings for component 'auth_cas', language 'zh_cn', branch 'MOODLE_20_STABLE'
 *
 * @package   auth_cas
...
$string['auth_cas_certificate_check'] = '如果您要验证服务器的证书，就设为“是”';
...
$string['auth_cas_logoutcas'] = '如果您希望与 Moodle断开连接时登出CAS ，就设置为“是”';
$string['auth_cas_logoutcas_key'] = '退出 CAS';
$string['auth_cas_multiauth'] = '如果您想有多种身份认证方式（CAS + 其他验证方式），将此设置为“是”。';
