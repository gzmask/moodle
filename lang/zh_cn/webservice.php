...
/**
 * Strings for component 'webservice', language 'zh_cn', branch 'MOODLE_20_STABLE'
 *
 * @package   webservice
...
$string['accessnotallowed'] = '不允许访问网络服务';
...
$string['errorinvalidparamsapi'] = '无效的外部 api 参数';
$string['errorinvalidparamsdesc'] = '无效的外部 api 描述';
$string['errorinvalidresponseapi'] = '无效的外部 api 应答';
$string['errorinvalidresponsedesc'] = '无效的外部 api 应答描述';
$string['errormissingkey'] = '在单个结构中缺少必须的 key：{$a}';
$string['errornotemptydefaultparamarray'] = '名为“{$a}”的网络服务描述参数是一个或多个结构。缺省值只能是空数组。请检查网络服务描述。';
$string['erroronlyarray'] = '只接受数组。';
$string['erroroptionalparamarray'] = '名为“{$a}”的网络服务描述参数是一个或多个结构。它不能被设为 VALUE_OPTIONAL。请检查网络服务描述。';
$string['errorresponsemissingkey'] = '应答中有错误——在单个结构中缺少下列必须的 key：{$a}';
$string['errorscalartype'] = '需要标量类型，但收到数组或对象。';
$string['errorunexpectedkey'] = '在参数数组中检测到不需要的 key（{$a}）';
$string['execute'] = '执行';
...
$string['invalidtokensession'] = '无效的基于会话的令牌——找不到会话或已过期';
...
$string['onesystemcontrolling'] = '用令牌控制 Moodle 的系统';
$string['onesystemcontrollingdescription'] = '下面步骤帮助您面向控制 Moodle 的系统来设置 Moodle 的网络服务。这些步骤也帮助您设置建议采用的令牌（安全密钥）认证方法。';
$string['operation'] = '操作';
$string['optional'] = '可选';
...
$string['wsauthmissing'] = '网络服务认证插件缺失。';
$string['wsauthnotenabled'] = '网络服务认证插件已禁用。';
