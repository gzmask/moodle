...
/**
 * Strings for component 'report_customlang', language 'zh_cn', branch 'MOODLE_20_STABLE'
 *
...
$string['checkin'] = '将字符串提交到磁盘';
$string['checkout'] = '将字符串同步到翻译器';
$string['checkoutdone'] = '字符串已成功同步到翻译器';
$string['checkoutinprogress'] = '正同步字符串到翻译器';
$string['confirmcheckin'] = '即将把修改过的字符串保存到您本地语言包中。这将从翻译器导出自定义的字符串到数据目录中，然后Moodle会开始使用这些修改过的字符串。按“继续”按钮开始导出。';
...
$string['modifiedno'] = '没有需要提交的已改动字符串。';
$string['modifiednum'] = '有 {$a}条 修改过的字符串。它们必须提交到磁盘才能永久保存。';
...
$string['savecheckin'] = '保存并提交字符串到文件';
$string['savecontinue'] = '保存并继续编辑';
