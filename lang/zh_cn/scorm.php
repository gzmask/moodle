...
/**
 * Strings for component 'scorm', language 'zh_cn', branch 'MOODLE_20_STABLE'
 *
 * @package   scorm
...
$string['whatgrade_help'] = '如果允许多次答题，那么此设置决定是将最高分、平均分、第一次得分还是最后一次得分记入成绩单。
...
$string['width'] = '宽度';
$string['window'] = '窗口';
$string['zlibwarning'] = '警告：此网站启用了 PHP Zlib 压缩。在某些浏览器中，用户打开 SCORM 对象时可能会遇到问题。';
