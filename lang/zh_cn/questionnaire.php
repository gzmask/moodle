...
/**
 * Strings for component 'questionnaire', language 'zh_cn', branch 'MOODLE_20_STABLE'
 *
...
$string['all'] = '所有';
$string['alreadyfilled'] = '您已经完成我们的问卷调查{$a}，谢谢您的参与。';
...
$string['closedate_help'] = '您可以在此指定问卷关闭的时间。选中该复选框并指定您想要的关闭日期及时间。
在该日期后，用户将不能填写问卷。如果该项未被选中，则问卷永远不会关闭。';
...
$string['downloadtextformat_help'] = '该特性允许您将问卷中的所有回答保存到文本文件中（CSV）。
该文件可以在以后被导入到电子表格（例如，MS Excel或Open Office Calc）或者统计软件中，以进一步处理这些数据。';
$string['dropdown'] = '下拉框';
$string['dropdown_help'] = '与单选按钮相比，使用下拉框没有特别的优势。
不过下拉框对于较长选项的问题，可以节约屏幕的面积。';
$string['edit'] = '编辑';
$string['editingquestionnaire'] = '编辑问卷设置';
$string['editquestion'] = '正在编辑{$a}类型问题';
$string['email'] = '电子邮件';
$string['errnewname'] = '抱歉，该名称已被占用。请选择一个新名。';
$string['errorcross'] = '交叉分析错误，问题的类型无效。';
...
$string['move'] = '移动此问题';
$string['movedn'] = '将问题位置下移';
$string['movehere'] = '将问题移动到此处';
$string['moveup'] = '将问题位置上移';
...
$string['opendate_help'] = '您可以在此指定开始问卷调查的时间。选中该复选框并指定您想要的开始日期及时间。在该日期前，用户不能填写问卷。如果该项未被选中，则问卷会立即开放。';
$string['option'] = '选项{$a}';
