...
/**
 * Strings for component 'moodle', language 'zh_cn', branch 'MOODLE_20_STABLE'
 *
 * @package   moodle
...
$string['availability_help'] = '这个设置决定课程是否出现在课程列表中。教师和管理员以外的其他用户都不能进入此课程。';
...
$string['blockdeleteconfirm'] = '您将完全删除版块“{$a}”。这将从数据库删除和此版块相关的全部数据。您确定要继续吗?';
$string['blockdeletefiles'] = '与版块“{$a->block}”相关联的所有数据都已经被删除了。要完成删除(并防止版块重新自动安装)，您应当从服务器上删除如下目录:{$a->directory}。';
$string['blocks'] = '版块';
...
$string['coursehelpnewsitemsnumber'] = '课程主页右边新闻框中显示的最近新闻条数<br />（设为0表示新闻框不会出现）';
...
$string['courserequestsuccess'] = '已经保存了您的课程申请。期望几天内会有 Email 通知您结果';
...
$string['emaildisplayhidden'] = '已隐藏email';
...
$string['flashlinkmessage'] = '请立刻升级您的Flash播放器：';
$string['flashupgrademessage'] = '此内容需要Flash插件才能播放，但是您安装的版本太旧了。

在升级后，您可能需要注销，然后再重新登录。';
$string['folder'] = '文件夹';
...
$string['hidetopicfromothers'] = '隐藏主题';
$string['hideweekfromothers'] = '隐藏星期';
$string['hits'] = '点击次数';
...
$string['legacythemesaved'] = '新的旧版主题已保存';
$string['license'] = '许可证';
$string['licenses'] = '许可证';
...
$string['livelogs'] = '日志';
$string['local'] = '本地';
$string['localplugindeleteconfirm'] = '您正要完全删除本地插件“{$a}”。这将从数据库删除与它有关的所有数据。您确信要继续吗？';
...
$string['notifyloginfailuresmessageend'] = '您可以在 {$a}/course/report/log/index.php?id=1&amp;chooselog=1&amp;modid=site_errors 查看日志。';
...
$string['optional'] = '可选的';
$string['order'] = '次序';
$string['orphanedactivities'] = '无主活动';
$string['other'] = '其它';
$string['outline'] = '概要';
...
$string['pluginchecknotice'] = '下表显示了在当前安装的Moodle中检测到的模块、版块和过滤器插件；其中有些是标准的，有些不是。在Moodle继续升级之前，应该检查所有非标准插件，并将它们升级到最新版。';
...
$string['screenreaderuse_help'] = '如果设为是，很多地方（比如聊天）的界面提供更易于用户访问方式（如视碍人士）。';
...
$string['showtopicfromothers'] = '显示主题';
$string['showweekfromothers'] = '显示星期';
$string['since'] = '开始时间';
...
$string['useforlegacytheme'] = '传统浏览器使用';
$string['useformaintheme'] = '现代浏览器使用';
