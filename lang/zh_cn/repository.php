...
/**
 * Strings for component 'repository', language 'zh_cn', branch 'MOODLE_20_STABLE'
 *
 * @package   repository
...
$string['confirmdelete'] = '您确信要删除容器{$a}吗？';
...
$string['enablecourseinstances'] = '允许用户向课程添加容器实例';
