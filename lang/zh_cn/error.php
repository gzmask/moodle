...
/**
 * Strings for component 'error', language 'zh_cn', branch 'MOODLE_20_STABLE'
 *
 * @package   error
...
$string['cannotnetgeo'] = '不能连接到NetGeo服务器 (http://netgeo.caida.org)，请检查代理设置，或最好安装MaxMind GeoLite City数据文件';
...
$string['invalidgradeitmeid'] = '无效的成绩项ID';
