...
/**
 * Strings for component 'message', language 'zh_cn', branch 'MOODLE_20_STABLE'
 *
 * @package   message
...
$string['cannotsavemessageprefs'] = '无法保存用户消息设置';
$string['contactlistempty'] = '您的联系人名单是空的';
$string['contacts'] = '联系人';
$string['context'] = '正文';
$string['couldnotfindpreference'] = '无法加载偏好 {$a}。您传递给 message_send() 的 component 和 name 能与 message_providers 中的某行匹配吗？消息提供者必须出现在数据库中，这样用户才能配置当收到消息时该怎样被通知。';
