...
/**
 * Strings for component 'debug', language 'zh_cn', branch 'MOODLE_20_STABLE'
 *
 * @package   debug
...
$string['invalidparameter'] = '检测到无效的参数值，操作无法继续。';
$string['invalidresponse'] = '检测到无效的响应值，操作无法继续。';
...
$string['noactivityname'] = '从page_generic_activity派生的页面对象没有定义$this->activityname';
