...
/**
 * Strings for component 'mimetypes', language 'zh_cn', branch 'MOODLE_20_STABLE'
 *
 * @package   mimetypes
...
$string['application/zip'] = 'ZIP 文档';
$string['audio/mp3'] = 'MP3 音频文件';
$string['audio/wav'] = 'WAV 音频文件';
$string['document/unknown'] = '普通文件';
$string['image/bmp'] = '未压缩的 BMP 图片';
$string['image/gif'] = 'GIF 图片';
$string['image/jpeg'] = 'JPEG 图片';
