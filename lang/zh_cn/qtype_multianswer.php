...
/**
 * Strings for component 'qtype_multianswer', language 'zh_cn', branch 'MOODLE_20_STABLE'
 *
...
$string['addingmultianswer'] = '添加内嵌答案(完形填空)题';
...
$string['editingmultianswer'] = '修改内嵌答案(完形填空)';
$string['layout'] = '布局';
...
$string['multianswer'] = '内嵌答案(完形填空)';
$string['multianswer_help'] = '内嵌答案(完形填空)题是一段文字，中间可以夹杂多道题目，例如选择题、填空题。';
$string['multianswersummary'] = '这种类型的题目非常灵活，但创建题目时必须输入特殊代码。可以内嵌的题目包括选择题、填空题和数字题。';
