...
/**
 * Strings for component 'completion', language 'zh_cn', branch 'MOODLE_20_STABLE'
 *
 * @package   completion
...
$string['addcourseprerequisite'] = '先修课程';
...
$string['completion-alt-auto-enabled'] = '系统根据条件设置标记此项是否完成';
$string['completion-alt-auto-fail'] = '已完成（成绩未及格）';
$string['completion-alt-auto-n'] = '未完成';
$string['completion-alt-auto-pass'] = '已完成（成绩及格）';
$string['completion-alt-auto-y'] = '已完成';
$string['completion-alt-manual-enabled'] = '学生可以手工标记此项为完成';
$string['completion-alt-manual-n'] = '未完成；点击标记为完成';
$string['completion-alt-manual-y'] = '已完成；点击标记为未完成';
...
$string['courseprerequisites'] = '先修课程';
...
$string['deletecoursecompletiondata'] = '删除课程进度数据';
...
$string['notenroled'] = '您没有加入本课';
$string['notyetstarted'] = '还未开始';
$string['overallcriteriaaggregation'] = '所有条件类型汇总';
$string['passinggrade'] = '及格线';
$string['pending'] = '等待中';
$string['periodpostenrolment'] = '选课后';
$string['prerequisites'] = '先决条件';
$string['prerequisitescompleted'] = '完成先决条件';
