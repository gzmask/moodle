...
/**
 * Strings for component 'simpletest', language 'zh_cn', branch 'MOODLE_20_STABLE'
 *
 * @package   simpletest
...
$string['testtablesneedupgrade'] = '测试数据库表需要升级。您想现在就升级吗？';
$string['testtablesok'] = '测试数据库表已成功安装。';
...
$string['unittestprefixsetting'] = '单元测试前缀：<strong>{$a->unittestprefix}</strong>（编辑 config.php 做修改）';
