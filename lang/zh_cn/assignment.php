...
/**
 * Strings for component 'assignment', language 'zh_cn', branch 'MOODLE_20_STABLE'
 *
 * @package   assignment
...
$string['enableemailnotification'] = '发送Email通知';
$string['enableemailnotification_help'] = '如果启用，那么评分后，学生能收到Email通知。';
...
$string['messageprovider:assignment_updates'] = '作业通知';
...
$string['nosubmitusers'] = '没有被允许提交此作业的用户';
